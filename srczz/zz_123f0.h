...
ZZ_123F0_13C:
	...
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x800123F0,0x8001244C,ZZ_123F0);
ZZ_MARK_TARGET(0x8001244C,0x80012458,ZZ_123F0_5C);
ZZ_MARK_TARGET(0x80012458,0x8001246C,ZZ_123F0_68);
ZZ_MARK_TARGET(0x8001246C,0x80012470,ZZ_123F0_7C);
ZZ_MARK_TARGET(0x80012470,0x80012488,ZZ_123F0_80);
ZZ_MARK_TARGET(0x80012488,0x80012498,ZZ_123F0_98);
ZZ_MARK_TARGET(0x80012498,0x800124C0,ZZ_123F0_A8);
ZZ_MARK_TARGET(0x800124C0,0x800124CC,ZZ_123F0_D0);
ZZ_MARK_TARGET(0x800124CC,0x800124DC,ZZ_123F0_DC);
ZZ_MARK_TARGET(0x800124DC,0x800124E8,ZZ_123F0_EC);
ZZ_MARK_TARGET(0x800124E8,0x800124F8,ZZ_123F0_F8);
ZZ_MARK_TARGET(0x800124F8,0x80012500,ZZ_123F0_108);
ZZ_MARK_TARGET(0x80012500,0x80012524,ZZ_123F0_110);
ZZ_MARK_TARGET(0x80012524,0x80012528,ZZ_123F0_134);
ZZ_MARK_TARGET(0x80012528,0x8001252C,ZZ_123F0_138);
ZZ_MARK_TARGET(0x8001252C,0x8001254C,ZZ_123F0_13C);
