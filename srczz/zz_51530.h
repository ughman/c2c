...
ZZ_51530_4C:
	...
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x80051530,0x80051558,ZZ_51530);
ZZ_MARK_TARGET(0x80051558,0x80051578,ZZ_51530_28);
ZZ_MARK_TARGET(0x80051578,0x8005157C,ZZ_51530_48);
ZZ_MARK_TARGET(0x8005157C,0x8005158C,ZZ_51530_4C);
