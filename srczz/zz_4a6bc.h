...
ZZ_4A6BC_48:
	...
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x8004A6BC,0x8004A6CC,ZZ_4A6BC);
ZZ_MARK_TARGET(0x8004A6CC,0x8004A6D8,ZZ_4A6BC_10);
ZZ_MARK_TARGET(0x8004A6D8,0x8004A6E4,ZZ_4A6BC_1C);
ZZ_MARK_TARGET(0x8004A6E4,0x8004A6FC,ZZ_4A6BC_28);
ZZ_MARK_TARGET(0x8004A6FC,0x8004A704,ZZ_4A6BC_40);
ZZ_MARK_TARGET(0x8004A704,0x8004A718,ZZ_4A6BC_48);
