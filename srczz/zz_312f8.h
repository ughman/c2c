...
ZZ_312F8_F4:
	...
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x800312F8,0x80031314,ZZ_312F8);
ZZ_MARK_TARGET(0x80031314,0x80031334,ZZ_312F8_1C);
ZZ_MARK_TARGET(0x80031334,0x80031354,ZZ_312F8_3C);
ZZ_MARK_TARGET(0x80031354,0x80031374,ZZ_312F8_5C);
ZZ_MARK_TARGET(0x80031374,0x80031380,ZZ_312F8_7C);
ZZ_MARK_TARGET(0x80031380,0x800313B8,ZZ_312F8_88);
ZZ_MARK_TARGET(0x800313B8,0x800313C4,ZZ_312F8_C0);
ZZ_MARK_TARGET(0x800313C4,0x800313E0,ZZ_312F8_CC);
ZZ_MARK_TARGET(0x800313E0,0x800313EC,ZZ_312F8_E8);
ZZ_MARK_TARGET(0x800313EC,0x800313F8,ZZ_312F8_F4);
