...
ZZ_1417C_B4:
	...
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x8001417C,0x800141C0,ZZ_1417C);
ZZ_MARK_TARGET(0x800141C0,0x800141E4,ZZ_1417C_44);
ZZ_MARK_TARGET(0x800141E4,0x800141EC,ZZ_1417C_68);
ZZ_MARK_TARGET(0x800141EC,0x800141FC,ZZ_1417C_70);
ZZ_MARK_TARGET(0x800141FC,0x80014204,ZZ_1417C_80);
ZZ_MARK_TARGET(0x80014204,0x8001420C,ZZ_1417C_88);
ZZ_MARK_TARGET(0x8001420C,0x80014214,ZZ_1417C_90);
ZZ_MARK_TARGET(0x80014214,0x80014224,ZZ_1417C_98);
ZZ_MARK_TARGET(0x80014224,0x80014230,ZZ_1417C_A8);
ZZ_MARK_TARGET(0x80014230,0x8001424C,ZZ_1417C_B4);
