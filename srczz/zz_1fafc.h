...
ZZ_1FAFC_90:
	...
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x8001FAFC,0x8001FB50,ZZ_1FAFC);
ZZ_MARK_TARGET(0x8001FB50,0x8001FB68,ZZ_1FAFC_54);
ZZ_MARK_TARGET(0x8001FB68,0x8001FB7C,ZZ_1FAFC_6C);
ZZ_MARK_TARGET(0x8001FB7C,0x8001FB88,ZZ_1FAFC_80);
ZZ_MARK_TARGET(0x8001FB88,0x8001FB8C,ZZ_1FAFC_8C);
ZZ_MARK_TARGET(0x8001FB8C,0x8001FB94,ZZ_1FAFC_90);
