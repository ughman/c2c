...
ZZ_3D664:
	...
	S1 = -S1;
	S1 = (int32_t)S1 >> 8;
	GTE_SetControlRegister(GTE_CREG_TRX,S0);
	GTE_SetControlRegister(GTE_CREG_TRY,S1);
	GTE_SetControlRegister(GTE_CREG_TRZ,V0);
...
ZZ_3D664_A4:
	...
	S1 = (int32_t)S1 >> 8;
	S2 = (int32_t)S2 >> 8;
	GTE_SetDataRegister(GTE_DREG_IR1,S0);
	GTE_SetDataRegister(GTE_DREG_IR2,S1);
	GTE_SetDataRegister(GTE_DREG_IR3,S2);
	GTE_Execute(4841490);
	S0 = GTE_GetDataRegister(GTE_DREG_IR1);
	S1 = GTE_GetDataRegister(GTE_DREG_IR2);
	S2 = GTE_GetDataRegister(GTE_DREG_IR3);
	GTE_SetControlRegister(GTE_CREG_TRX,S0);
	GTE_SetControlRegister(GTE_CREG_TRY,S1);
	GTE_SetControlRegister(GTE_CREG_TRZ,S2);
...
ZZ_3D664_3E0:
	...
	T2 = T1 & 0xFFFF;
	T3 &= 0xFFFF;
	GTE_SetControlRegister(GTE_CREG_RT13_RT21,R0);
	GTE_SetControlRegister(GTE_CREG_RT31_RT32,R0);
	GTE_SetDataRegister(GTE_DREG_VZ0,T0);
	AT = T3 << 16;
	AT |= T7;
	GTE_SetDataRegister(GTE_DREG_VXY0,AT);
	GP = LO;
	GTE_SetControlRegister(GTE_CREG_RT11_RT12,R0);
	GTE_SetControlRegister(GTE_CREG_RT22_RT23,T5);
	GTE_SetControlRegister(GTE_CREG_RT33_NONE,T2);
	EMU_SMultiply(T6,T1);
	GP = (int32_t)GP >> 12;
	GTE_Execute(4743186);
	GTE_SetControlRegister(GTE_CREG_RT11_RT12,T0);
	GTE_SetControlRegister(GTE_CREG_RT22_RT23,T0);
	AT = GP & 0xFFFF;
	GTE_SetControlRegister(GTE_CREG_RT33_NONE,AT);
	S7 = LO;
	SP = GTE_GetDataRegister(GTE_DREG_IR2);
	S0 = GTE_GetDataRegister(GTE_DREG_IR3);
	EMU_SMultiply(T6,GP);
	S7 = (int32_t)S7 >> 12;
	GTE_Execute(4743186);
	GTE_SetControlRegister(GTE_CREG_RT11_RT12,T4);
	GTE_SetControlRegister(GTE_CREG_RT22_RT23,T4);
	AT = SP & 0xFFFF;
	GTE_SetControlRegister(GTE_CREG_RT33_NONE,AT);
	T8 = LO;
	S1 = GTE_GetDataRegister(GTE_DREG_IR1);
	S2 = GTE_GetDataRegister(GTE_DREG_IR2);
	S3 = GTE_GetDataRegister(GTE_DREG_IR3);
	EMU_SMultiply(T4,SP);
	GTE_Execute(4743186);
	T8 = (int32_t)T8 >> 12;
	S4 = GTE_GetDataRegister(GTE_DREG_IR1);
	S5 = GTE_GetDataRegister(GTE_DREG_IR2);
	S6 = GTE_GetDataRegister(GTE_DREG_IR3);
	AT = LO;
	AT = (int32_t)AT >> 12;
	S2 = S2 - T8;
	S7 = -S7;
	...
	T3 = (int32_t)T3 >> A3;
	T4 = (int32_t)T4 >> A3;
	GTE_SetControlRegister(GTE_CREG_RT11_RT12,T2);
	GTE_SetControlRegister(GTE_CREG_RT13_RT21,R0);
	GTE_SetControlRegister(GTE_CREG_RT22_RT23,T3);
	GTE_SetControlRegister(GTE_CREG_RT31_RT32,R0);
	GTE_SetControlRegister(GTE_CREG_RT33_NONE,T4);
	GTE_SetDataRegister(GTE_DREG_IR1,S3);
	GTE_SetDataRegister(GTE_DREG_IR2,S0);
	GTE_SetDataRegister(GTE_DREG_IR3,S4);
	GTE_Execute(4841490);
	S3 = GTE_GetDataRegister(GTE_DREG_IR1);
	S0 = GTE_GetDataRegister(GTE_DREG_IR2);
	S4 = GTE_GetDataRegister(GTE_DREG_IR3);
	GTE_SetDataRegister(GTE_DREG_IR1,S2);
	GTE_SetDataRegister(GTE_DREG_IR2,S7);
	GTE_SetDataRegister(GTE_DREG_IR3,S1);
	T0 = S3;
	GTE_Execute(4841490);
	T1 = S0;
	S2 = GTE_GetDataRegister(GTE_DREG_IR1);
	S7 = GTE_GetDataRegister(GTE_DREG_IR2);
	S1 = GTE_GetDataRegister(GTE_DREG_IR3);
	T2 = S4;
	S3 <<= 2;
	S3 = S3 - T0;
	S3 = (int32_t)S3 >> 2;
	...
	GTE_SetControlRegister(GTE_CREG_RT22_RT23,T2);
	GTE_SetControlRegister(GTE_CREG_RT31_RT32,R0);
	GTE_SetControlRegister(GTE_CREG_RT33_NONE,R0);
	AT = 0x1F800000;
	S0 = EMU_ReadU32(AT);
