...
ZZ_3D664:
	...
	S1 = -S1;
	S1 = (int32_t)S1 >> 8;
	GTE_SetControlRegister(5,S0);
	GTE_SetControlRegister(6,S1);
	GTE_SetControlRegister(7,V0);
...
ZZ_3D664_A4:
	...
	S1 = (int32_t)S1 >> 8;
	S2 = (int32_t)S2 >> 8;
	GTE_SetDataRegister(9,S0);
	GTE_SetDataRegister(10,S1);
	GTE_SetDataRegister(11,S2);
	GTE_Execute(4841490);
	S0 = GTE_GetDataRegister(9);
	S1 = GTE_GetDataRegister(10);
	S2 = GTE_GetDataRegister(11);
	GTE_SetControlRegister(5,S0);
	GTE_SetControlRegister(6,S1);
	GTE_SetControlRegister(7,S2);
...
ZZ_3D664_3E0:
	...
	T2 = T1 & 0xFFFF;
	T3 &= 0xFFFF;
	GTE_SetControlRegister(1,R0);
	GTE_SetControlRegister(3,R0);
	GTE_SetDataRegister(1,T0);
	AT = T3 << 16;
	AT |= T7;
	GTE_SetDataRegister(0,AT);
	GP = LO;
	GTE_SetControlRegister(0,R0);
	GTE_SetControlRegister(2,T5);
	GTE_SetControlRegister(4,T2);
	EMU_SMultiply(T6,T1);
	GP = (int32_t)GP >> 12;
	GTE_Execute(4743186);
	GTE_SetControlRegister(0,T0);
	GTE_SetControlRegister(2,T0);
	AT = GP & 0xFFFF;
	GTE_SetControlRegister(4,AT);
	S7 = LO;
	SP = GTE_GetDataRegister(10);
	S0 = GTE_GetDataRegister(11);
	EMU_SMultiply(T6,GP);
	S7 = (int32_t)S7 >> 12;
	GTE_Execute(4743186);
	GTE_SetControlRegister(0,T4);
	GTE_SetControlRegister(2,T4);
	AT = SP & 0xFFFF;
	GTE_SetControlRegister(4,AT);
	T8 = LO;
	S1 = GTE_GetDataRegister(9);
	S2 = GTE_GetDataRegister(10);
	S3 = GTE_GetDataRegister(11);
	EMU_SMultiply(T4,SP);
	GTE_Execute(4743186);
	T8 = (int32_t)T8 >> 12;
	S4 = GTE_GetDataRegister(9);
	S5 = GTE_GetDataRegister(10);
	S6 = GTE_GetDataRegister(11);
	AT = LO;
	AT = (int32_t)AT >> 12;
	S2 = S2 - T8;
	S7 = -S7;
	...
	T3 = (int32_t)T3 >> A3;
	T4 = (int32_t)T4 >> A3;
	GTE_SetControlRegister(0,T2);
	GTE_SetControlRegister(1,R0);
	GTE_SetControlRegister(2,T3);
	GTE_SetControlRegister(3,R0);
	GTE_SetControlRegister(4,T4);
	GTE_SetDataRegister(9,S3);
	GTE_SetDataRegister(10,S0);
	GTE_SetDataRegister(11,S4);
	GTE_Execute(4841490);
	S3 = GTE_GetDataRegister(9);
	S0 = GTE_GetDataRegister(10);
	S4 = GTE_GetDataRegister(11);
	GTE_SetDataRegister(9,S2);
	GTE_SetDataRegister(10,S7);
	GTE_SetDataRegister(11,S1);
	T0 = S3;
	GTE_Execute(4841490);
	T1 = S0;
	S2 = GTE_GetDataRegister(9);
	S7 = GTE_GetDataRegister(10);
	S1 = GTE_GetDataRegister(11);
	T2 = S4;
	S3 <<= 2;
	S3 = S3 - T0;
	S3 = (int32_t)S3 >> 2;
