...
ZZ_52B90_F0:
	...
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x80052B90,0x80052BFC,ZZ_52B90);
ZZ_MARK_TARGET(0x80052BFC,0x80052C24,ZZ_52B90_6C);
ZZ_MARK_TARGET(0x80052C24,0x80052C3C,ZZ_52B90_94);
ZZ_MARK_TARGET(0x80052C3C,0x80052C48,ZZ_52B90_AC);
ZZ_MARK_TARGET(0x80052C48,0x80052C58,ZZ_52B90_B8);
ZZ_MARK_TARGET(0x80052C58,0x80052C70,ZZ_52B90_C8);
ZZ_MARK_TARGET(0x80052C70,0x80052C80,ZZ_52B90_E0);
ZZ_MARK_TARGET(0x80052C80,0x80052C88,ZZ_52B90_F0);
