...
ZZ_42C68_E8:
	...
	EMU_Write32(V1 + 120,T3); //+ 0x78
	S3 = GTE_GetDataRegister(0);
	GP = GTE_GetDataRegister(1);
	RA = 0x80042D80; //ZZ_42C68_118
	T8 = GP + T2;
	ZZ_CLOCKCYCLES(12,0x80042C68);
	goto ZZ_42C68;
ZZ_42C68_118:
	GTE_SetDataRegister(0,S3);
	GTE_SetDataRegister(1,GP);
...
ZZ_42C68_120:
	...
	GP = GTE_GetDataRegister(3);
	RA = 0x80042DA4; //ZZ_42C68_13C
	T8 = GP + T2;
	ZZ_CLOCKCYCLES(7,0x80042C68);
	goto ZZ_42C68;
ZZ_42C68_13C:
	GTE_SetDataRegister(2,S3);
	GTE_SetDataRegister(3,GP);
...
ZZ_42C68_144:
	...
	goto ZZ_42C68;
ZZ_42C68_15C:
	GTE_SetDataRegister(4,S3);
	GTE_SetDataRegister(5,GP);
