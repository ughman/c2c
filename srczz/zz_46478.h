...
ZZ_46478:
	...
	EMU_Write32(V1 + 400,GTE_GetDataRegister(12)); //+ 0x190
	EMU_Write32(V1 + 408,GTE_GetDataRegister(13)); //+ 0x198
	EMU_Write32(V1 + 416,GTE_GetDataRegister(14)); //+ 0x1A0
	EMU_Write32(V1 + 404,GTE_GetDataRegister(17)); //+ 0x194
	EMU_Write32(V1 + 412,GTE_GetDataRegister(18)); //+ 0x19C
	EMU_Write32(V1 + 420,GTE_GetDataRegister(19)); //+ 0x1A4
	T8 = GTE_GetDataRegister(0);
	T9 = GTE_GetDataRegister(2);
	A0 = GTE_GetDataRegister(4);
	T9 = T9 - T8;
	A0 = A0 - T8;
	T8 <<= 16;
	T9 <<= 16;
	...
	T8 = GTE_GetDataRegister(1);
	T9 = GTE_GetDataRegister(3);
...
ZZ_46478_360:
	...
	A0 = EMU_ReadU8(A0);
	T9 |= A1;
	GTE_SetDataRegister(6,T9);
	A0 <<= 5;
	GTE_SetDataRegister(9,A0);
	GTE_SetDataRegister(10,A0);
	GTE_SetDataRegister(11,A0);
	T8 += S2;
	T8 = EMU_ReadU8(T8);
	GTE_Execute(6815785);
	...
	EMU_Write32(AT,GTE_GetDataRegister(22));
...
ZZ_46478_440:
	T8 = GTE_GetDataRegister(19);
	EMU_Write32(AT + 4,GTE_GetDataRegister(14)); //+ 0x4
