...
ZZ_41A1C_284:
	...
	goto ZZ_41A1C_124;
#endif
ZZ_MARK_TARGET(0x80041A1C,0x80041A40,ZZ_41A1C);
ZZ_MARK_TARGET(0x80041A40,0x80041A48,ZZ_41A1C_24);
ZZ_MARK_TARGET(0x80041A48,0x80041A54,ZZ_41A1C_2C);
ZZ_MARK_TARGET(0x80041A54,0x80041A5C,ZZ_41A1C_38);
ZZ_MARK_TARGET(0x80041A5C,0x80041A64,ZZ_41A1C_40);
ZZ_MARK_TARGET(0x80041A64,0x80041A6C,ZZ_41A1C_48);
ZZ_MARK_TARGET(0x80041A6C,0x80041A7C,ZZ_41A1C_50);
ZZ_MARK_TARGET(0x80041A7C,0x80041A8C,ZZ_41A1C_60);
ZZ_MARK_TARGET(0x80041A8C,0x80041AA0,ZZ_41A1C_70);
ZZ_MARK_TARGET(0x80041AA0,0x80041AB4,ZZ_41A1C_84);
ZZ_MARK_TARGET(0x80041AB4,0x80041B40,ZZ_41A1C_98);
ZZ_MARK_TARGET(0x80041B40,0x80041B50,ZZ_41A1C_124);
ZZ_MARK_TARGET(0x80041B50,0x80041B90,ZZ_41A1C_134);
ZZ_MARK_TARGET(0x80041B90,0x80041B9C,ZZ_41A1C_174);
ZZ_MARK_TARGET(0x80041B9C,0x80041BBC,ZZ_41A1C_180);
ZZ_MARK_TARGET(0x80041BBC,0x80041C04,ZZ_41A1C_1A0);
ZZ_MARK_TARGET(0x80041C04,0x80041C3C,ZZ_41A1C_1E8);
ZZ_MARK_TARGET(0x80041C3C,0x80041C44,ZZ_41A1C_220);
ZZ_MARK_TARGET(0x80041C44,0x80041C5C,ZZ_41A1C_228);
ZZ_MARK_TARGET(0x80041C5C,0x80041C64,ZZ_41A1C_240);
ZZ_MARK_TARGET(0x80041C64,0x80041C6C,ZZ_41A1C_248);
ZZ_MARK_TARGET(0x80041C6C,0x80041C98,ZZ_41A1C_250);
ZZ_MARK_TARGET(0x80041C98,0x80041CA0,ZZ_41A1C_27C);
ZZ_MARK_TARGET(0x80041CA0,0x80041D10,ZZ_41A1C_284);
