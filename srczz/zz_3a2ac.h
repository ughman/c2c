...
ZZ_3A2AC_660:
	...
	goto ZZ_3A2AC_58;
#endif
ZZ_MARK_TARGET(0x8003A2AC,0x8003A304,ZZ_3A2AC);
ZZ_MARK_TARGET(0x8003A304,0x8003A330,ZZ_3A2AC_58);
ZZ_MARK_TARGET(0x8003A330,0x8003A36C,ZZ_3A2AC_84);
ZZ_MARK_TARGET(0x8003A36C,0x8003A374,ZZ_3A2AC_C0);
ZZ_MARK_TARGET(0x8003A374,0x8003A380,ZZ_3A2AC_C8);
ZZ_MARK_TARGET(0x8003A380,0x8003A390,ZZ_3A2AC_D4);
ZZ_MARK_TARGET(0x8003A390,0x8003A398,ZZ_3A2AC_E4);
ZZ_MARK_TARGET(0x8003A398,0x8003A3A4,ZZ_3A2AC_EC);
ZZ_MARK_TARGET(0x8003A3A4,0x8003A3B4,ZZ_3A2AC_F8);
ZZ_MARK_TARGET(0x8003A3B4,0x8003A3BC,ZZ_3A2AC_108);
ZZ_MARK_TARGET(0x8003A3BC,0x8003A3C8,ZZ_3A2AC_110);
ZZ_MARK_TARGET(0x8003A3C8,0x8003A3DC,ZZ_3A2AC_11C);
ZZ_MARK_TARGET(0x8003A3DC,0x8003A3E4,ZZ_3A2AC_130);
ZZ_MARK_TARGET(0x8003A3E4,0x8003A3F0,ZZ_3A2AC_138);
ZZ_MARK_TARGET(0x8003A3F0,0x8003A404,ZZ_3A2AC_144);
ZZ_MARK_TARGET(0x8003A404,0x8003A40C,ZZ_3A2AC_158);
ZZ_MARK_TARGET(0x8003A40C,0x8003A418,ZZ_3A2AC_160);
ZZ_MARK_TARGET(0x8003A418,0x8003A42C,ZZ_3A2AC_16C);
ZZ_MARK_TARGET(0x8003A42C,0x8003A434,ZZ_3A2AC_180);
ZZ_MARK_TARGET(0x8003A434,0x8003A440,ZZ_3A2AC_188);
ZZ_MARK_TARGET(0x8003A440,0x8003A44C,ZZ_3A2AC_194);
ZZ_MARK_TARGET(0x8003A44C,0x8003A454,ZZ_3A2AC_1A0);
ZZ_MARK_TARGET(0x8003A454,0x8003A460,ZZ_3A2AC_1A8);
ZZ_MARK_TARGET(0x8003A460,0x8003A46C,ZZ_3A2AC_1B4);
ZZ_MARK_TARGET(0x8003A46C,0x8003A474,ZZ_3A2AC_1C0);
ZZ_MARK_TARGET(0x8003A474,0x8003A47C,ZZ_3A2AC_1C8);
ZZ_MARK_TARGET(0x8003A47C,0x8003A488,ZZ_3A2AC_1D0);
ZZ_MARK_TARGET(0x8003A488,0x8003A498,ZZ_3A2AC_1DC);
ZZ_MARK_TARGET(0x8003A498,0x8003A4A0,ZZ_3A2AC_1EC);
ZZ_MARK_TARGET(0x8003A4A0,0x8003A4AC,ZZ_3A2AC_1F4);
ZZ_MARK_TARGET(0x8003A4AC,0x8003A4C0,ZZ_3A2AC_200);
ZZ_MARK_TARGET(0x8003A4C0,0x8003A4C8,ZZ_3A2AC_214);
ZZ_MARK_TARGET(0x8003A4C8,0x8003A4D4,ZZ_3A2AC_21C);
ZZ_MARK_TARGET(0x8003A4D4,0x8003A4E4,ZZ_3A2AC_228);
ZZ_MARK_TARGET(0x8003A4E4,0x8003A4EC,ZZ_3A2AC_238);
ZZ_MARK_TARGET(0x8003A4EC,0x8003A4F8,ZZ_3A2AC_240);
ZZ_MARK_TARGET(0x8003A4F8,0x8003A50C,ZZ_3A2AC_24C);
ZZ_MARK_TARGET(0x8003A50C,0x8003A514,ZZ_3A2AC_260);
ZZ_MARK_TARGET(0x8003A514,0x8003A520,ZZ_3A2AC_268);
ZZ_MARK_TARGET(0x8003A520,0x8003A530,ZZ_3A2AC_274);
ZZ_MARK_TARGET(0x8003A530,0x8003A538,ZZ_3A2AC_284);
ZZ_MARK_TARGET(0x8003A538,0x8003A544,ZZ_3A2AC_28C);
ZZ_MARK_TARGET(0x8003A544,0x8003A558,ZZ_3A2AC_298);
ZZ_MARK_TARGET(0x8003A558,0x8003A560,ZZ_3A2AC_2AC);
ZZ_MARK_TARGET(0x8003A560,0x8003A56C,ZZ_3A2AC_2B4);
ZZ_MARK_TARGET(0x8003A56C,0x8003A578,ZZ_3A2AC_2C0);
ZZ_MARK_TARGET(0x8003A578,0x8003A580,ZZ_3A2AC_2CC);
ZZ_MARK_TARGET(0x8003A580,0x8003A58C,ZZ_3A2AC_2D4);
ZZ_MARK_TARGET(0x8003A58C,0x8003A59C,ZZ_3A2AC_2E0);
ZZ_MARK_TARGET(0x8003A59C,0x8003A5A4,ZZ_3A2AC_2F0);
ZZ_MARK_TARGET(0x8003A5A4,0x8003A5B0,ZZ_3A2AC_2F8);
ZZ_MARK_TARGET(0x8003A5B0,0x8003A5C0,ZZ_3A2AC_304);
ZZ_MARK_TARGET(0x8003A5C0,0x8003A5C8,ZZ_3A2AC_314);
ZZ_MARK_TARGET(0x8003A5C8,0x8003A5D4,ZZ_3A2AC_31C);
ZZ_MARK_TARGET(0x8003A5D4,0x8003A5EC,ZZ_3A2AC_328);
ZZ_MARK_TARGET(0x8003A5EC,0x8003A5F4,ZZ_3A2AC_340);
ZZ_MARK_TARGET(0x8003A5F4,0x8003A600,ZZ_3A2AC_348);
ZZ_MARK_TARGET(0x8003A600,0x8003A658,ZZ_3A2AC_354);
ZZ_MARK_TARGET(0x8003A658,0x8003A660,ZZ_3A2AC_3AC);
ZZ_MARK_TARGET(0x8003A660,0x8003A66C,ZZ_3A2AC_3B4);
ZZ_MARK_TARGET(0x8003A66C,0x8003A674,ZZ_3A2AC_3C0);
ZZ_MARK_TARGET(0x8003A674,0x8003A680,ZZ_3A2AC_3C8);
ZZ_MARK_TARGET(0x8003A680,0x8003A68C,ZZ_3A2AC_3D4);
ZZ_MARK_TARGET(0x8003A68C,0x8003A694,ZZ_3A2AC_3E0);
ZZ_MARK_TARGET(0x8003A694,0x8003A69C,ZZ_3A2AC_3E8);
ZZ_MARK_TARGET(0x8003A69C,0x8003A6A8,ZZ_3A2AC_3F0);
ZZ_MARK_TARGET(0x8003A6A8,0x8003A6B8,ZZ_3A2AC_3FC);
ZZ_MARK_TARGET(0x8003A6B8,0x8003A6C4,ZZ_3A2AC_40C);
ZZ_MARK_TARGET(0x8003A6C4,0x8003A6D0,ZZ_3A2AC_418);
ZZ_MARK_TARGET(0x8003A6D0,0x8003A6DC,ZZ_3A2AC_424);
ZZ_MARK_TARGET(0x8003A6DC,0x8003A6E8,ZZ_3A2AC_430);
ZZ_MARK_TARGET(0x8003A6E8,0x8003A704,ZZ_3A2AC_43C);
ZZ_MARK_TARGET(0x8003A704,0x8003A710,ZZ_3A2AC_458);
ZZ_MARK_TARGET(0x8003A710,0x8003A720,ZZ_3A2AC_464);
ZZ_MARK_TARGET(0x8003A720,0x8003A73C,ZZ_3A2AC_474);
ZZ_MARK_TARGET(0x8003A73C,0x8003A748,ZZ_3A2AC_490);
ZZ_MARK_TARGET(0x8003A748,0x8003A768,ZZ_3A2AC_49C);
ZZ_MARK_TARGET(0x8003A768,0x8003A778,ZZ_3A2AC_4BC);
ZZ_MARK_TARGET(0x8003A778,0x8003A780,ZZ_3A2AC_4CC);
ZZ_MARK_TARGET(0x8003A780,0x8003A788,ZZ_3A2AC_4D4);
ZZ_MARK_TARGET(0x8003A788,0x8003A794,ZZ_3A2AC_4DC);
ZZ_MARK_TARGET(0x8003A794,0x8003A7A8,ZZ_3A2AC_4E8);
ZZ_MARK_TARGET(0x8003A7A8,0x8003A7BC,ZZ_3A2AC_4FC);
ZZ_MARK_TARGET(0x8003A7BC,0x8003A7C8,ZZ_3A2AC_510);
ZZ_MARK_TARGET(0x8003A7C8,0x8003A7D4,ZZ_3A2AC_51C);
ZZ_MARK_TARGET(0x8003A7D4,0x8003A7E0,ZZ_3A2AC_528);
ZZ_MARK_TARGET(0x8003A7E0,0x8003A7FC,ZZ_3A2AC_534);
ZZ_MARK_TARGET(0x8003A7FC,0x8003A80C,ZZ_3A2AC_550);
ZZ_MARK_TARGET(0x8003A80C,0x8003A824,ZZ_3A2AC_560);
ZZ_MARK_TARGET(0x8003A824,0x8003A82C,ZZ_3A2AC_578);
ZZ_MARK_TARGET(0x8003A82C,0x8003A838,ZZ_3A2AC_580);
ZZ_MARK_TARGET(0x8003A838,0x8003A854,ZZ_3A2AC_58C);
ZZ_MARK_TARGET(0x8003A854,0x8003A880,ZZ_3A2AC_5A8);
ZZ_MARK_TARGET(0x8003A880,0x8003A88C,ZZ_3A2AC_5D4);
ZZ_MARK_TARGET(0x8003A88C,0x8003A898,ZZ_3A2AC_5E0);
ZZ_MARK_TARGET(0x8003A898,0x8003A8B0,ZZ_3A2AC_5EC);
ZZ_MARK_TARGET(0x8003A8B0,0x8003A8B8,ZZ_3A2AC_604);
ZZ_MARK_TARGET(0x8003A8B8,0x8003A8D8,ZZ_3A2AC_60C);
ZZ_MARK_TARGET(0x8003A8D8,0x8003A8E0,ZZ_3A2AC_62C);
ZZ_MARK_TARGET(0x8003A8E0,0x8003A8EC,ZZ_3A2AC_634);
ZZ_MARK_TARGET(0x8003A8EC,0x8003A904,ZZ_3A2AC_640);
ZZ_MARK_TARGET(0x8003A904,0x8003A90C,ZZ_3A2AC_658);
ZZ_MARK_TARGET(0x8003A90C,0x8003A918,ZZ_3A2AC_660);
