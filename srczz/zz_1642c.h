...
ZZ_1642C_9C:
	...
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x8001642C,0x80016454,ZZ_1642C);
ZZ_MARK_TARGET(0x80016454,0x8001645C,ZZ_1642C_28);
ZZ_MARK_TARGET(0x8001645C,0x8001646C,ZZ_1642C_30);
ZZ_MARK_TARGET(0x8001646C,0x80016488,ZZ_1642C_40);
ZZ_MARK_TARGET(0x80016488,0x80016494,ZZ_1642C_5C);
ZZ_MARK_TARGET(0x80016494,0x800164A8,ZZ_1642C_68);
ZZ_MARK_TARGET(0x800164A8,0x800164C4,ZZ_1642C_7C);
ZZ_MARK_TARGET(0x800164C4,0x800164C8,ZZ_1642C_98);
ZZ_MARK_TARGET(0x800164C8,0x800164E4,ZZ_1642C_9C);
