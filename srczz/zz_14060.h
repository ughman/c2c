...
ZZ_14060_6C:
	...
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x80014060,0x800140AC,ZZ_14060);
ZZ_MARK_TARGET(0x800140AC,0x800140BC,ZZ_14060_4C);
ZZ_MARK_TARGET(0x800140BC,0x800140C4,ZZ_14060_5C);
ZZ_MARK_TARGET(0x800140C4,0x800140CC,ZZ_14060_64);
ZZ_MARK_TARGET(0x800140CC,0x800140DC,ZZ_14060_6C);
