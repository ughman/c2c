...
ZZ_36FA4_118:
	...
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x80036FA4,0x80036FEC,ZZ_36FA4);
ZZ_MARK_TARGET(0x80036FEC,0x80037014,ZZ_36FA4_48);
ZZ_MARK_TARGET(0x80037014,0x8003701C,ZZ_36FA4_70);
ZZ_MARK_TARGET(0x8003701C,0x8003702C,ZZ_36FA4_78);
ZZ_MARK_TARGET(0x8003702C,0x8003703C,ZZ_36FA4_88);
ZZ_MARK_TARGET(0x8003703C,0x80037064,ZZ_36FA4_98);
ZZ_MARK_TARGET(0x80037064,0x8003708C,ZZ_36FA4_C0);
ZZ_MARK_TARGET(0x8003708C,0x800370A4,ZZ_36FA4_E8);
ZZ_MARK_TARGET(0x800370A4,0x800370A8,ZZ_36FA4_100);
ZZ_MARK_TARGET(0x800370A8,0x800370BC,ZZ_36FA4_104);
ZZ_MARK_TARGET(0x800370BC,0x800370C8,ZZ_36FA4_118);
