...
ZZ_414B0_3E0:
	...
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x800414B0,0x800414E0,ZZ_414B0);
ZZ_MARK_TARGET(0x800414E0,0x800414F0,ZZ_414B0_30);
ZZ_MARK_TARGET(0x800414F0,0x800414FC,ZZ_414B0_40);
ZZ_MARK_TARGET(0x800414FC,0x80041514,ZZ_414B0_4C);
ZZ_MARK_TARGET(0x80041514,0x80041520,ZZ_414B0_64);
ZZ_MARK_TARGET(0x80041520,0x8004152C,ZZ_414B0_70);
ZZ_MARK_TARGET(0x8004152C,0x80041534,ZZ_414B0_7C);
ZZ_MARK_TARGET(0x80041534,0x8004153C,ZZ_414B0_84);
ZZ_MARK_TARGET(0x8004153C,0x80041548,ZZ_414B0_8C);
ZZ_MARK_TARGET(0x80041548,0x8004158C,ZZ_414B0_98);
ZZ_MARK_TARGET(0x8004158C,0x80041598,ZZ_414B0_DC);
ZZ_MARK_TARGET(0x80041598,0x800415CC,ZZ_414B0_E8);
ZZ_MARK_TARGET(0x800415CC,0x800415DC,ZZ_414B0_11C);
ZZ_MARK_TARGET(0x800415DC,0x80041610,ZZ_414B0_12C);
ZZ_MARK_TARGET(0x80041610,0x80041620,ZZ_414B0_160);
ZZ_MARK_TARGET(0x80041620,0x80041628,ZZ_414B0_170);
ZZ_MARK_TARGET(0x80041628,0x80041630,ZZ_414B0_178);
ZZ_MARK_TARGET(0x80041630,0x80041638,ZZ_414B0_180);
ZZ_MARK_TARGET(0x80041638,0x80041644,ZZ_414B0_188);
ZZ_MARK_TARGET(0x80041644,0x80041688,ZZ_414B0_194);
ZZ_MARK_TARGET(0x80041688,0x80041694,ZZ_414B0_1D8);
ZZ_MARK_TARGET(0x80041694,0x800416C8,ZZ_414B0_1E4);
ZZ_MARK_TARGET(0x800416C8,0x800416D4,ZZ_414B0_218);
ZZ_MARK_TARGET(0x800416D4,0x80041708,ZZ_414B0_224);
ZZ_MARK_TARGET(0x80041708,0x80041718,ZZ_414B0_258);
ZZ_MARK_TARGET(0x80041718,0x80041720,ZZ_414B0_268);
ZZ_MARK_TARGET(0x80041720,0x80041728,ZZ_414B0_270);
ZZ_MARK_TARGET(0x80041728,0x80041730,ZZ_414B0_278);
ZZ_MARK_TARGET(0x80041730,0x8004173C,ZZ_414B0_280);
ZZ_MARK_TARGET(0x8004173C,0x80041780,ZZ_414B0_28C);
ZZ_MARK_TARGET(0x80041780,0x8004178C,ZZ_414B0_2D0);
ZZ_MARK_TARGET(0x8004178C,0x800417C0,ZZ_414B0_2DC);
ZZ_MARK_TARGET(0x800417C0,0x800417CC,ZZ_414B0_310);
ZZ_MARK_TARGET(0x800417CC,0x80041800,ZZ_414B0_31C);
ZZ_MARK_TARGET(0x80041800,0x80041810,ZZ_414B0_350);
ZZ_MARK_TARGET(0x80041810,0x80041814,ZZ_414B0_360);
ZZ_MARK_TARGET(0x80041814,0x80041824,ZZ_414B0_364);
ZZ_MARK_TARGET(0x80041824,0x8004182C,ZZ_414B0_374);
ZZ_MARK_TARGET(0x8004182C,0x80041858,ZZ_414B0_37C);
ZZ_MARK_TARGET(0x80041858,0x80041860,ZZ_414B0_3A8);
ZZ_MARK_TARGET(0x80041860,0x80041890,ZZ_414B0_3B0);
ZZ_MARK_TARGET(0x80041890,0x80041898,ZZ_414B0_3E0);
