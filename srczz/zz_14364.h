...
ZZ_14364_D0:
	...
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x80014364,0x800143A8,ZZ_14364);
ZZ_MARK_TARGET(0x800143A8,0x800143B8,ZZ_14364_44);
ZZ_MARK_TARGET(0x800143B8,0x800143C4,ZZ_14364_54);
ZZ_MARK_TARGET(0x800143C4,0x800143C8,ZZ_14364_60);
ZZ_MARK_TARGET(0x800143C8,0x800143EC,ZZ_14364_64);
ZZ_MARK_TARGET(0x800143EC,0x80014404,ZZ_14364_88);
ZZ_MARK_TARGET(0x80014404,0x80014410,ZZ_14364_A0);
ZZ_MARK_TARGET(0x80014410,0x8001441C,ZZ_14364_AC);
ZZ_MARK_TARGET(0x8001441C,0x80014434,ZZ_14364_B8);
ZZ_MARK_TARGET(0x80014434,0x80014450,ZZ_14364_D0);
