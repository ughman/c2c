...
ZZ_366AC_58:
	...
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x800366AC,0x800366C0,ZZ_366AC);
ZZ_MARK_TARGET(0x800366C0,0x800366E4,ZZ_366AC_14);
ZZ_MARK_TARGET(0x800366E4,0x800366EC,ZZ_366AC_38);
ZZ_MARK_TARGET(0x800366EC,0x800366F4,ZZ_366AC_40);
ZZ_MARK_TARGET(0x800366F4,0x800366FC,ZZ_366AC_48);
ZZ_MARK_TARGET(0x800366FC,0x80036704,ZZ_366AC_50);
ZZ_MARK_TARGET(0x80036704,0x80036714,ZZ_366AC_58);
