...
ZZ_36C10_60:
	...
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x80036C10,0x80036C3C,ZZ_36C10);
ZZ_MARK_TARGET(0x80036C3C,0x80036C58,ZZ_36C10_2C);
ZZ_MARK_TARGET(0x80036C58,0x80036C70,ZZ_36C10_48);
ZZ_MARK_TARGET(0x80036C70,0x80036C8C,ZZ_36C10_60);
