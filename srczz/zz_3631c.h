...
ZZ_3631C_40:
	...
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x8003631C,0x8003632C,ZZ_3631C);
ZZ_MARK_TARGET(0x8003632C,0x80036340,ZZ_3631C_10);
ZZ_MARK_TARGET(0x80036340,0x80036348,ZZ_3631C_24);
ZZ_MARK_TARGET(0x80036348,0x80036350,ZZ_3631C_2C);
ZZ_MARK_TARGET(0x80036350,0x8003635C,ZZ_3631C_34);
ZZ_MARK_TARGET(0x8003635C,0x8003636C,ZZ_3631C_40);
