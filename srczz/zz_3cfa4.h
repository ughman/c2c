...
ZZ_3CFA4_AC:
	...
	if (A1 == T0)
	{
		ZZ_CLOCKCYCLES(6,0x8003D24C);
		goto ZZ_3CFA4_2A8;
	}
	if (A1)
	{
		ZZ_CLOCKCYCLES(8,0x8003D0A4);
		goto ZZ_3CFA4_100;
	}
	S4 = A0 >> 16;
	S4 <<= 8;
...
ZZ_3CFA4_100:
	...
	{
		A0 = S4 >> S7;
		ZZ_CLOCKCYCLES(26,0x8003D110);
		goto ZZ_3CFA4_16C;
	}
	A0 = S4 >> S7;
	A0 = S4 >> GP;
	ZZ_CLOCKCYCLES(27,0x8003D110);
ZZ_3CFA4_16C:
	T3 += A0;
	...
	{
		A0 = S5 >> T8;
		ZZ_CLOCKCYCLES(4,0x8003D124);
		goto ZZ_3CFA4_180;
	}
	A0 = S5 >> T8;
	A0 = S5 >> GP;
	ZZ_CLOCKCYCLES(5,0x8003D124);
ZZ_3CFA4_180:
	T4 += A0;
...
ZZ_3CFA4_194:
	...
	{
		A0 = A0 < 768;
		ZZ_CLOCKCYCLES(12,0x8003D21C);
		goto ZZ_3CFA4_278;
	}
	A0 = A0 < 768;
	if (!A0)
	{
		ZZ_CLOCKCYCLES(14,0x8003D21C);
		goto ZZ_3CFA4_278;
	}
	ZZ_CLOCKCYCLES(14,0x8003D170);
ZZ_3CFA4_1CC:
	A0 = 0x1F800000;
	A0 |= 0xF0;
	EMU_Write32(A0,AT);
	...
	EMU_Write32(AT + 48,RA); //+ 0x30
	A0 = 0x1F800000;
	A0 |= 0xE4;
	V0 = EMU_ReadU32(A0);
	A0 = EMU_ReadU32(A0 + 8); //+ 0x8
	ZZ_JUMPREGISTER_BEGIN(V0);
	RA = 0x8003D1D0; //ZZ_3CFA4_22C
	ZZ_CLOCKCYCLES_JR(24);
	// UNIMPLEMENTED JUMP-TO-REGISTER-AND-LINK (V0,8003D1C8)
	ZZ_JUMPREGISTER_END();
ZZ_3CFA4_22C:
	AT = 0x1F800000;
	AT |= 0x70;
	...
	ZZ_CLOCKCYCLES(19,0x8003D21C);
ZZ_3CFA4_278:
	A0 = (int32_t)V1 < (int32_t)T4;
	if (A0)
	{
		ZZ_CLOCKCYCLES(3,0x8003D244);
		goto ZZ_3CFA4_2A0;
	}
	if (!T0)
	{
		ZZ_CLOCKCYCLES(5,0x8003D23C);
		goto ZZ_3CFA4_298;
	}
	T1 += 1;
	AT += T4;
...
ZZ_3CFA4_298:
	A2 += 1;
	A3 += T4;
	ZZ_CLOCKCYCLES(2,0x8003D244);
ZZ_3CFA4_2A0:
	T2 += 8;
	ZZ_CLOCKCYCLES(2,0x8003D050);
	goto ZZ_3CFA4_AC;
ZZ_3CFA4_2A8:
	T2 = 0x1F800000;
	T2 |= 0xE0;
	...
	ZZ_CLOCKCYCLES(11,0x8003D278);
ZZ_3CFA4_2D4:
	if (!T1)
	{
		EMU_Write32(A0 + 8,T2); //+ 0x8
		ZZ_CLOCKCYCLES(2,0x8003D28C);
		goto ZZ_3CFA4_2E8;
	}
	EMU_Write32(A0 + 8,T2); //+ 0x8
	EMU_SDivide(AT,T1);
...
ZZ_3CFA4_2E8:
	...
	ZZ_JUMPREGISTER(0x8002A858,ZZ_2A6C4_194);
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x8003CFA4,0x8003D050,ZZ_3CFA4);
ZZ_MARK_TARGET(0x8003D050,0x8003D0A4,ZZ_3CFA4_AC);
ZZ_MARK_TARGET(0x8003D0A4,0x8003D110,ZZ_3CFA4_100);
ZZ_MARK_TARGET(0x8003D110,0x8003D124,ZZ_3CFA4_16C);
ZZ_MARK_TARGET(0x8003D124,0x8003D138,ZZ_3CFA4_180);
ZZ_MARK_TARGET(0x8003D138,0x8003D170,ZZ_3CFA4_194);
ZZ_MARK_TARGET(0x8003D170,0x8003D1D0,ZZ_3CFA4_1CC);
ZZ_MARK_TARGET(0x8003D1D0,0x8003D21C,ZZ_3CFA4_22C);
ZZ_MARK_TARGET(0x8003D21C,0x8003D23C,ZZ_3CFA4_278);
ZZ_MARK_TARGET(0x8003D23C,0x8003D244,ZZ_3CFA4_298);
ZZ_MARK_TARGET(0x8003D244,0x8003D24C,ZZ_3CFA4_2A0);
ZZ_MARK_TARGET(0x8003D24C,0x8003D278,ZZ_3CFA4_2A8);
ZZ_MARK_TARGET(0x8003D278,0x8003D28C,ZZ_3CFA4_2D4);
ZZ_MARK_TARGET(0x8003D28C,0x8003D2D8,ZZ_3CFA4_2E8);
