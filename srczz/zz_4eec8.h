...
ZZ_4EEC8_10:
	...
	T0 = 341;
	GTE_SetControlRegister(29,T0);
	T0 = 256;
	GTE_SetControlRegister(30,T0);
	T0 = 1000;
	GTE_SetControlRegister(26,T0);
	T0 = -4194;
	GTE_SetControlRegister(27,T0);
	T0 = 0x1400000;
	GTE_SetControlRegister(28,T0);
	GTE_SetControlRegister(24,R0);
	GTE_SetControlRegister(25,R0);
