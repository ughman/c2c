...
ZZ_4920C_F4:
	...
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x8004920C,0x80049244,ZZ_4920C);
ZZ_MARK_TARGET(0x80049244,0x80049248,ZZ_4920C_38);
ZZ_MARK_TARGET(0x80049248,0x80049284,ZZ_4920C_3C);
ZZ_MARK_TARGET(0x80049284,0x80049298,ZZ_4920C_78);
ZZ_MARK_TARGET(0x80049298,0x800492C0,ZZ_4920C_8C);
ZZ_MARK_TARGET(0x800492C0,0x800492C8,ZZ_4920C_B4);
ZZ_MARK_TARGET(0x800492C8,0x800492D0,ZZ_4920C_BC);
ZZ_MARK_TARGET(0x800492D0,0x800492E0,ZZ_4920C_C4);
ZZ_MARK_TARGET(0x800492E0,0x800492F8,ZZ_4920C_D4);
ZZ_MARK_TARGET(0x800492F8,0x80049300,ZZ_4920C_EC);
ZZ_MARK_TARGET(0x80049300,0x80049310,ZZ_4920C_F4);
